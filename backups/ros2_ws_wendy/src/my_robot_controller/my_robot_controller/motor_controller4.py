...
# Drift compensation
# If robot drifts right, reduce RIGHT_TRIM a bit more.
# If robot drifts left, reduce LEFT_TRIM a bit more.
LEFT_TRIM = 1.00
RIGHT_TRIM = 1.00

# Small threshold to decide when robot is "basically going straight"
STRAIGHT_ANGULAR_THRESHOLD = 0.05
...
class MotorControllerNode(Node):
    ...
    def cmd_vel_callback(self, msg: Twist):
        ...
        # Apply trim mainly when moving straight
        if abs(angular) < STRAIGHT_ANGULAR_THRESHOLD and abs(linear) > 0.0:
