...
class EncoderOdometryNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('left_encoder_a_pin', 11)
        self.declare_parameter('left_encoder_b_pin', 13)
        self.declare_parameter('right_encoder_a_pin', 15)
        self.declare_parameter('right_encoder_b_pin', 22)
